...
$sql = $db->query('SELECT * FROM tb_dokter WHERE is_active=1');
$row = $sql->getResult();
$i = 1;
                            ...
                            <tbody>
                                <?php foreach ($row as $psn) : ?>
                                    <tr>
                                        ...
                                        <td><?= $psn->no_telp; ?></td>
                                        <td>
                                            <a class="text-success fas fa-eye" href='<?= base_url(); ?>/Dokter/detail/<?= $psn->id_dokter; ?>'></a>
                                        </td>
                                        <td><a class="fas fa-edit" href='<?= base_url(); ?>/Dokter/edit/<?= $psn->id_dokter; ?>'></a> </td>
                                        <td><a onclick="delId(this)" id='del' class="text-danger fas fa-trash" value='<?= $psn->id_dokter; ?>'></a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
